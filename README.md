<img src="/public\GamerTalkLogotransparent.png" alt="Header" title="Header" width="400">
...
3. This application uses Firebase for authentication and to store user's chat history. Please contact us and we'll provide you with credentials to log into Firebase through a `.env`. Use the `.env.example` file to see what variables are required.
